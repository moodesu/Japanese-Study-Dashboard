...
assert.match(app,/class="resource-action textbook-pages-button"[\s\S]*?class="resource-action-icon" aria-hidden="true">▤<\/span>View \$\{esc\(step\.page\)\}/,'Guided textbook actions share the icon-and-label component');
