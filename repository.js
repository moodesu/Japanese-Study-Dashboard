...
function repositoryBrowseMarkup(){
  ...
  return `<section class="repo-page">
    <div class="repo-page-head app-page-heading"><div><div class="eyebrow">Japanese Repository</div><h1>Capture and reuse real Japanese</h1><p>Sentences, corrections and grammar from Japanese you actually encounter.</p></div><div class="repo-head-actions"><button class="smallbtn primary" id="repoAdd">＋ Capture</button><button class="smallbtn" id="repoImport">Import JSON</button><button class="smallbtn" id="repoGrammarLibrary">Grammar Library</button><button class="smallbtn migaku-btn" id="repoAnkiBulk" ${entries.length?'':'disabled'}>Export Anki</button><button class="smallbtn" id="repoMigakuBulk" ${entries.length?'':'disabled'}>Export TSV</button></div></div>
